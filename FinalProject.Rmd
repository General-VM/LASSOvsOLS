...
for (i in 1:5) {
  ...
  print(paste0("Summary Statistics for q when p = ", p))
  writeLines("\nOLS Statistics\n")
...
```{r, echo=FALSE}
kable(summary_df, caption = "MSE for OLS and LASSO")
```


# 4. Conclusion

From the outputs, we can see that LASSO has a much smaller mean squared
...
OLS's mean squared error increases as $p$ increases. Further, we can see
that LASSO typically has a higher number of relevant predictors ($q$)
than OLS based on the summary statistics generated.
