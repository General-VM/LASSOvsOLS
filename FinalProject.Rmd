...
$$\hat\beta_{OLS}=argmin_\beta \frac{1}{2n} \|Y-X\beta\|^2_{2}$$
where 
- Y = $(Y_1, ..., Y_n)^T$ is n x 1 response vector 
- X = $(X_1, ..., X_n)^T$ is n x p design matrix of covariates
- $\beta$ = $(Y_1, ..., Y_n)^T$ is p-dimensional regression coefficient vector 
